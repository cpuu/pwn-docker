...
RUN apt-get update && \
    apt-get install -y sudo gcc-multilib cmake vim build-essential pkg-config git gdb python3-dev python3-pip python3-setuptools libglib2.0-dev libc6-dbg apt-utils
